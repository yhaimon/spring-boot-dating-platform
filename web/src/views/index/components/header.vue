...
<script setup>
  ...
  let menuData = ref([
    ...
    //{ link: 'applyView', title: '个人中心' },
    { link: 'userInfoEditView', title: '个人中心' },
    { link: 'squareDynamics', title: '动态广场' },
  ...
  watch(
    ...
    (newPath, _) => {
      ...
      //} 
      else if (newPath.indexOf('/index/usercenter/userInfoEditView') > -1) {
        selectedMenu.value = 'userInfoEditView';
      } else if (newPath.indexOf('/index/recommend') > -1) {
        selectedMenu.value = 'recommend';
      } else if (newPath.indexOf('/index/squareDynamics') > -1) {
        selectedMenu.value = 'squareDynamics';
      }
    },
    { immediate: true },
  );
    ...
    .main-bar-view {
      ...
      .menu {
        ...
        .menu-item-selected {
          ...
          font-weight: bold;
          line-height: 48px;
          border-bottom: 4px solid #f7a3a3;
          background: linear-gradient(128deg, #e0bdf1, #f3b7f7 59%, #eea6f6 100%);
          border-radius: 10%;
        }
      }
    }
