...
<script setup>
  ...
  import LogoIcon from '/@/assets/images/k-logo.svg';
...
<style scoped lang="less">
  ...
  .pc-style {
    ...
    border-radius: 30px;
    -webkit-box-shadow: 2px 2px 6px #dd5ee8;
    box-shadow: 4px 4px 8px rgb(186, 109, 219);
  }
  ...
  .next-btn {
    background: linear-gradient(128deg, #ba89e0, #6b3d96 59%, #cc8ee4 100%);
    border-radius: 4px;
    color: #fff;
    font-size: 18px;
    font-weight: 500;
  ...
  .next-btn:hover {
    background: linear-gradient(128deg, #decaee, #bb80f3 59%, #e4b7f6 100%);
    color: #6b3d96;
  }
