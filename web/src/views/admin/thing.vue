            ...
            <a-row :gutter="24">
              ...
              <a-col span="24">
                <a-form-item label="用户Id" name="userId">                 
                  <a-input placeholder="请输入" v-model:value="modal.form.userId" />
                </a-form-item>
              </a-col>
              <!--******** 结束 ******** -->
              ...
              <a-col span="12">
                <a-form-item label="性别" name="sex">
                  <a-input placeholder="请输入“男”或“女”" v-model:value="modal.form.sex" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="身高" name="shengao">
                  <a-input placeholder="请输入身高，比如：180cm" v-model:value="modal.form.shengao" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="体重" name="tizhong">
                  <a-input placeholder="请输入体重，比如：66kg" v-model:value="modal.form.tizhong" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
              ...
              <a-col span="12">
                <a-form-item label="年龄" name="age">
                  <a-input placeholder="请输入年龄" v-model:value="modal.form.age" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
              ...
              <a-col span="12">
                <a-form-item label="居住地" name="address">
                  <a-input placeholder="请输入居住地，比如：北京" v-model:value="modal.form.address" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
              ...
              <a-col span="12">
                <a-form-item label="状态" name="status">
                  <a-select placeholder="请选择" allowClear v-model:value="modal.form.status">
                    <a-select-option key="0" value="0">上架相亲</a-select-option>
                    <a-select-option key="1" value="1">下架相亲</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
            </a-row>
...
<script setup>
  ...
  import { checkUserIdExistsApi,createApi, listApi, updateApi, deleteApi } from '/@/api/thing';
...
/*   const handleOk = () => {
    myform.value
      ...
      .then(() => {
        ...
        if (modal.form.userId) {
          checkUserIdExistsApi(modal.form.userId).then((response) => {
            if (response.data.exists) {
              //console.log(modal.form.userId)
              formData.append('userId', modal.form.userId);
              // ********
  ...
  /* const handleOk = () => {
    myform.value
      ...
      .then(() => {
        // 检查用户是否存在
        checkUserIdExistsApi(modal.form.userId)
          .then(response => {
            if (response.data.exists) {
              message.error('用户不存在');
              return; // 终止后续操作
