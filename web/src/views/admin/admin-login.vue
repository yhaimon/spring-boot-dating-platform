      ...
      <div class="main">
        <div class="main_right">
          ...
          <a-form ref="myform" layout="vertical" :model="data.loginForm" :rules="data.rules" :hideRequiredMark="true">
            <a-form-item name="username" label="账号" class="txtLabel" :colon="false">
              <a-input size="large" placeholder="请输入登录账号" v-model:value="data.loginForm.username" @pressEnter="handleSubmit">
                <a-icon slot="prefix" type="user" />
              </a-input>
            </a-form-item>
            <a-form-item name="password" label="密码"  class="txtLabel" :colon="false">
              <a-input
                size="large"
                type="password"
                placeholder="请输入登录密码"
  ...
  #userLayout {
    ...
    .main-container {
      ...
      .main {
        ...
        box-shadow: 4px 4px 8px #73a0ec;

        .main_right {
          background:rgb(231, 192, 255);
          background: linear-gradient(128deg, #e69bf2, #82c5f8 59%, #cc8ee4 100%);
          ...
          .login-button {
            background: linear-gradient(128deg, #10b7ea, #006fc4 59%, #cc8ee4 100%);
          }
          .login-button:hover {
            color: #006fc4;
            background: linear-gradient(128deg, #a6daea, #4baaf2 59%, #dcb8ea 100%);
          }
        }
